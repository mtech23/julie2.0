          ...
          <div class="row"  data-aos="fade-up">
            <div class="col-md-12">
              ...
              <img  src="images/file.png" class="img-fluid star">
                ...
                <a href="artwork.php" class="art_work">Artwork</a>
                <h6 class="price"> Price </h6>
                <!-- <div class="slidecontainer">
                  <p class="range_number">Price: <span id="demo"></span></p>
          ...
          <div data-aos="fade-right">
                    <div class="jewelry_main_boxes">
                      ...
                      <img  src="images/file.png" class="img-fluid star_three">
                        <img class="jewelry_image jewelry_images_animate img-fluid " src="images/storeImg01.png">
                      </div>
                ...
                <div data-aos="fade-right">
                    <div class="jewelry_main_boxes">
                      <div class="jewelry_box_img"><img class="jewelry_image jewelry_images_animate img-fluid " src="images/storeImg02.png"></div>
                      <h5 class="product_name product_name_one">Product Name</h5>
                      <p class="product_description product_description_one">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                      <a class="details details_one" href="javascript:;">Details</a>
                    </div>
                ...
                <div data-aos="fade-right">
                    <div class="jewelry_main_boxes">
                      <div class="jewelry_box_img"><img class="jewelry_image jewelry_images_animate img-fluid " src="images/storeImg03.png"></div>
                      <h5 class="product_name product_name_one">Product Name</h5>
                      <p class="product_description product_description_one">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                      <a class="details details_one" href="javascript:;">Details</a>
                    </div>
                ...
                <div data-aos="fade-left">
                  <div class="jewelry_main_boxes">
                    <div class="jewelry_box_img"><img class="jewelry_image animated_jewelry_image img-fluid " src="images/storeImg06.png"></div>
                    <h5 class="product_name product_name_two">Product Name</h5>
                    <p class="product_description product_description_two">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                    <a class="details details_two" href="javascript:;">Details</a>
                  </div>
                ...
                <div data-aos="fade-left">
                  <div class="jewelry_main_boxes">
                    <div class="jewelry_box_img"><img class="jewelry_image animated_jewelry_image img-fluid " src="images/storeImg07.png"></div>
                    <h5 class="product_name product_name_two">Product Name</h5>
                    <p class="product_description product_description_two">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                    <a class="details details_two" href="javascript:;">Details</a>
                  </div>
            ...
            <div data-aos="fade-right">
                <div class="jewelry_main_boxes">
                  <div class="jewelry_box_img"><img class="jewelry_image animated_jewelry_images_thirdRow img-fluid " src="images/storeImg10.png"></div>
                  <h5 class="product_name product_name_three">Product Name</h5>
                  <p class="product_description product_description_three">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                  <a class="details details_three" href="javascript:;">Details</a>
                </div>
            ...
            <div data-aos="fade-right">
              <div class="jewelry_main_boxes">
                <div class="jewelry_box_img"><img class="jewelry_image animated_jewelry_images_thirdRow img-fluid " src="images/storeImg11.png"></div>
                <h5 class="product_name product_name_three">Product Name</h5>
                <p class="product_description product_description_three">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                <a class="details details_three" href="javascript:;">Details</a>
              </div>
